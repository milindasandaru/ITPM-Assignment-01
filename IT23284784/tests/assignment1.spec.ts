...
const testCases = [
  ...
  { id: 'Pos_Fun_0009', input: 'api okkoma heta yanavaa', type: 'M', desc: 'Plural Form', category: 'Daily language usage, Plural form, M (31-299 characters), Accuracy validation' },
  ...
  { id: 'Pos_Fun_0011', input: 'mama iiyee chess play karaa', type: 'M', desc: 'Past Tense', category: 'Daily language usage, Past tense, M (31-299 characters), Accuracy validation' },
  ...
  { id: 'Pos_Fun_0017', input: 'Rs. 2500 k dhenna puluvandha', type: 'M', desc: 'Currency & Numbers', category: 'Punctuation/numbers, Interrogative (question), M (31-299 characters), Accuracy validation' },
  { id: 'Pos_Fun_0018', input: 'heta 10.30 a.m. venakota enna', type: 'M', desc: 'Time Format', category: 'Punctuation/numbers, Imperative (command), M (31-299 characters), Accuracy validation' },
  ...
  { id: 'Pos_Fun_0020', input: 'mama dhaen gedhara yanavaa.  heta ennam.', type: 'M', desc: 'Line Breaks (Modified)', category: 'Formatting (line breaks), Compound sentence, M (31-299 characters), Formatting preservation' },
  { id: 'Pos_Fun_0021', input: 'Suba aluth avurudhdhak veevaa!', type: 'M', desc: 'Punctuation Marks', category: 'Punctuation/numbers, Greeting/request/response, M (31-299 characters), Accuracy validation' },
  ...
  { id: 'Pos_Fun_0023', input: 'lQQkaavee bohoma dhigu ithihaasayak thiyena ratak. eyata avurudhu 2500 kata vadaa paeraNi liKitha ithihaasayak thiyenavaa. AnuraaDhapuraya, poLonnaruva vagee nagara vala thiyena puraaNa vasthu balanna godak tourists la enavaa. Api eevaa raeka ganna ooni.', type: 'L', desc: 'Long Input (>300)', category: 'Daily language usage, Complex sentence, L (≥300 characters), Accuracy validation' },
